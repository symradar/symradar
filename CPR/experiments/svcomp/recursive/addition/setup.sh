...
program_dir=/root/projects/CPR/data/svcomp/sv-benchmarks/c/recursive
...
cd $program_dir
make CXX=$CPR_CXX CC=$CPR_CC  LDFLAGS="-lcpr_runtime -L/root/projects/CPR/lib -L/root/projects/uni-klee/build/lib  -lkleeRuntest -I/root/projects/uni-klee/include" -j32 Addition02
