...
cd $program_dir
make CXX=$CPR_CXX CC=$CPR_CC  LDFLAGS="-lcpr_runtime -L/root/projects/CPR/lib -L/root/projects/uni-klee/build/lib  -lkleeRuntest -I/root/projects/uni-klee/include" -j32 standard_running-1
