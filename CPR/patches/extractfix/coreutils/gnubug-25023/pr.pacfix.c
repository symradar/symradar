...
{
AFL_INIT_SET0234("./pr", "/root/projects/CPR/patches/extractfix/coreutils/gnubug-25003/dummy", "-m", "/root/projects/CPR/patches/extractfix/coreutils/gnubug-25003/dummy");
...
init_parameters (int number_of_files)
{
  ...
  lines_per_body = lines_per_page - lines_per_header - lines_per_footer + ((buff) - (buff) + (buff_allocated) - (buff_allocated) + (buff_current) - (buff_current) + (chars_per_column) - (chars_per_column) + (chars_per_input_tab) - (chars_per_input_tab) + (chars_per_line) - (chars_per_line) + (chars_per_margin) - (chars_per_margin) + (chars_per_number) - (chars_per_number) + (chars_per_output_tab) - (chars_per_output_tab) + (clump_buff) - (clump_buff) + (col_sep_length) - (col_sep_length) + (col_sep_string) - (col_sep_string) + (column_separator) - (column_separator) + (column_vector) - (column_vector) + (columns) - (columns) + (custom_header) - (custom_header) + (date_format) - (date_format) + (date_text) - (date_text) + (end_vector) - (end_vector) + (file_text) - (file_text) + (files_ready_to_read) - (files_ready_to_read) + (first_page_number) - (first_page_number) + (header_width_available) - (header_width_available) + (input_position) - (input_position) + (input_tab_char) - (input_tab_char) + (last_page_number) - (last_page_number) + (line_count) - (line_count) + (line_number) - (line_number) + (line_separator) - (line_separator) + (line_vector) - (line_vector) + (lines_per_body) - (lines_per_body) + (lines_per_page) - (lines_per_page) + (number_buff) - (number_buff) + (number_separator) - (number_separator) + (number_width) - (number_width) + (output_position) - (output_position) + (output_tab_char) - (output_tab_char) + (padding_not_printed) - (padding_not_printed) + (page_number) - (page_number) + (separators_not_printed) - (separators_not_printed) + (spaces_not_printed) - (spaces_not_printed) + (start_line_num) - (start_line_num) + (total_files) - (total_files) + (chars_used_by_number) - (chars_used_by_number) + (number_of_files) - (number_of_files));
  if (lines_per_body <= 0)
    {
      extremities = false;
      keep_FF = true;
