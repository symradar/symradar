...
typedef std::map<llvm::Instruction *, std::map<llvm::Function *, CallSiteInfo>>
...
public:
  CallPathNode(CallPathNode *parent, llvm::Instruction *callSite,
               llvm::Function *function);
...
private:
  CallPathNode *computeCallPath(CallPathNode *parent,
                                llvm::Instruction *callSite, llvm::Function *f);
...
public:
  ...
  CallPathNode *getCallPath(CallPathNode *parent, llvm::Instruction *callSite,
                            llvm::Function *f);
};
} // namespace klee
