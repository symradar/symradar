 ...
 * @deprecated
 */
public class NewConditionImpliesOriginalCondition extends SafepatchHeuristic{

	private HashMap types;

	public NewConditionImpliesOriginalCondition(FunctionDiff diff) {
		super(diff);
	...
	public boolean applyOnDelta(ASTDelta d) {
		...
		return HeuristicsHelper.getNewImpliesOriginal(cDiffs).size() > 0;
	}
